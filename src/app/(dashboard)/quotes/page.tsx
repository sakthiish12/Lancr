    ...
    <div>
      ...
      <div className="p-6 space-y-6">
        ...
        <div className="flex gap-2">
          {['All', 'Draft', 'Sent', 'Approved', 'Expired'].map((filter) => (
            <button
              key={filter}
              className="rounded-lg border border-gray-200 bg-white px-3 py-1.5 text-sm text-gray-600 hover:bg-gray-50 first:bg-gray-900 first:text-white first:border-gray-900"
            >
              {filter}
            </button>
          ))}
